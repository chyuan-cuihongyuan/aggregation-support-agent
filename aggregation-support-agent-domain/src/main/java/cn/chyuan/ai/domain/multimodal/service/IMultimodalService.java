...
public interface IMultimodalService {
    ...
    List<CrossModalSearchResultVO> textToImageSearch(String query, int topK, TenantScopeVO scope);

    List<CrossModalSearchResultVO> imageToTextSearch(byte[] imageData, int topK, TenantScopeVO scope);
